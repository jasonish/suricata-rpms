...
%changelog
* Tue May  8 2018 Jason Ish <ish@unx.ca> - %%VERSION%%-1
- Remove %file for suricatasc Python egg.
- Add the rules that are not installed to the datadir.

* Wed Feb  7 2018 Jason Ish <ish@unx.ca> 4.0.3-2
- Sync up with Fedora package.

* Wed Feb  7 2018 Jason Ish <ish@unx.ca> - %%VERSION%%-1
- Add support for suricatactl.
...
* Thu Jul 27 2017 Jason Ish <ish@unx.ca> - 2017.07.27.1501191550-1
- Enable Hyperscan on EPEL 7.
...
* Tue Jun 06 2017 Jason Ish <ish@unx.ca> - 3.2.1-2
