...
Source0: http://www.openinfosecfoundation.org/download/%{name}-%{version}RC3.tar.gz
...
make DESTDIR="%{buildroot}" "bindir=%{_sbindir}" install-conf

# Copy over the included rules.
